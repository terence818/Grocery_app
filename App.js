  ...
  return (
    <Provider store={store}>
      <NavigationContainer>
        <Stack.Navigator
        // screenOptions={{
        //   header: (props) => <CustomAppBar {...props} type={'edit'} />,
        // }}
        >
          ...
          <Stack.Screen name="ChatbotScreen"
            options={{ header: (props) => <CustomAppBar {...props} title='Chatbot' /> }}
          ...
          <Stack.Screen name="OrdersVendorScreen"
            options={{ header: (props) => <CustomAppBar {...props} title='Credit Card' /> }}
          ...
          <Stack.Screen name="Vendor" component={VendorHomeScreen} />
